...
$stk_data = [
    ...
    "PhoneNumber" => $phone,
    "CallBackURL" => "https://df45-41-89-246-254.ngrok-free.app -> http://localhost:80/npm/callback.php", 
...
mysqli_stmt_bind_param($stmt, 'sidsi', $checkout_id, $user_id, $amount, $created_at, $id);
