...
curl_setopt($ch, CURLOPT_HTTPHEADER, ['Authorization: Basic SHkxTjF2Y1R0QkdiaUZOR2RGTUZoWFIySmE5aEEzVTJHeUxLVWwwUkpFZE9zYjlkOkJUYVNUc2tyUEZBbml4V1laUnhHU2NCQzJRbVptSXViZFNtR3R4b3pOQUdLSko4Q2JMQURuTWNQTUVLNGU2RjM=']);
...
$stk_data = [
    ...
    "PhoneNumber" => $phone,
    "CallBackURL" => "https://b462-102-0-18-196.ngrok-free.app/npm/callback.php", 
...
//     $sql="INSERT INTO mpesa_request (checkout_id ,user_id,amount ,created_at,product_id )
//     VALUES(?, ? ,?, ?,?)";
// $stmt=mysqli_prepare($conn,$sql);
//  mysqli_stmt_bind_param($stmt, 'sidsi',$response['CheckoutRequestID'], $user_id,  $amount, date('Y-m-d H:i:s'),$id);
//  mysqli_stmt_execute($stmt);
//  if (mysqli_stmt_affected_rows($stmt) > 0) {
//     echo json_encode(["status" => "success", "message" => "STK Push initiated.", "checkout_id" => $response['CheckoutRequestID']]);
// } else {
//     echo json_encode(["status" => "error", "message" => "Failed to save STK request."]);
// }
