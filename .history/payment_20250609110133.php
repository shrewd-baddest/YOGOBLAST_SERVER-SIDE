...
if(isset($_SESSION["userId"])) {
   ...
   // echo $userData;
    ...
    echo json_encode(["status" => "error", "message" => "User not logged in. Cannot proceed with payment."]);
    exit;
}
...
$stk_data = [
    ...
    "PhoneNumber" => $phone,
    "CallBackURL" => "https://4270-197-248-94-18.ngrok-free.app/npm/callback.php", 
...
file_put_contents("callback_log.json", $callbackJSON, FILE_APPEND); // save it to a file
