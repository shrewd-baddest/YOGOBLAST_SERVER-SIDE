...
if($row['statuz']==0){
    $sql2="INSERT INTO ORDER_ITEMS(oder_id, product_id,price, quantity) VALUES (?, ?, ?, ?)";
    ...
    $price= $order_details['price'] ?? null;
    mysqli_stmt_bind_param($stmt2, 'iidi', $row['id'], $product_id,$row['total_price'], $quantity); 
