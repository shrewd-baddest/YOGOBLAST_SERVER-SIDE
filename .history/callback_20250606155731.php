...
$sql="INSERT INTO orders (user_id,phoneNumber,reciept,total_price,order_date,statuz) VALUES (?, ?, ?, ?, ?, ?)";
$stmt = mysqli_prepare($conn,$sql);
 
 mysqli_stmt_bind_param($stmt, 'iisiss', $user_id, $phone, $receipt, $amount, $date, $resultCode);
